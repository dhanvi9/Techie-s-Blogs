...
@app.route("/")
def home():
    flash('Stay updated with new tech!! Subscribe to get emails about our latest blogs.',"info")
    #flash('Stay updated with new tech!! Subscribe to get emails about the latest blogs.', "success")
...
def dashboard():
    ...
    if request.method=='POST':
        ...
        userpass=request.form.get('passwrd')
